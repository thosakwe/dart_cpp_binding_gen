...
namespace cpp_binding_generator {
  ...
  class List {
    public:
      ...
      template < typename T >
      void copyRange(List< T >& target, int64_t at, List< T >& source, int64_t start = 0, int64_t end = 0);
      template < typename T >
      void writeIterable(List< T >& target, int64_t at, Iterable< T >& source);
      template < typename R >
      List< R >& cast();
      E operator[](int64_t index);
      void setAt(int64_t index, E value);
      void add(E value);
      void addAll(Iterable< E >& iterable);
      void sort(Dart_Handle compare);
      ...
      void clear();
      void insert(int64_t index, E element);
      void insertAll(int64_t index, Iterable< E >& iterable);
      void setAll(int64_t index, Iterable< E >& iterable);
      bool remove(Object& value);
      E removeAt(int64_t index);
      E removeLast();
      void removeWhere(Dart_Handle test);
      void retainWhere(Dart_Handle test);
      List< E >& operator+(List< E >& other);
      List< E >& sublist(int64_t start, int64_t end = 0);
      Iterable< E >& getRange(int64_t start, int64_t end);
      void setRange(int64_t start, int64_t end, Iterable< E >& iterable, int64_t skipCount = 0);
      void removeRange(int64_t start, int64_t end);
      void fillRange(int64_t start, int64_t end, E fillValue);
      void replaceRange(int64_t start, int64_t end, Iterable< E >& replacement);
      Map< int64_t, E >& asMap();
  ...
  class Iterable {
    public:
      ...
      Dart_Handle getHandle() const;
      Iterable();
      static Iterable generate(int64_t count, Dart_Handle generator);
      ...
      E firstWhere(Dart_Handle test, Dart_Handle orElse);
      E lastWhere(Dart_Handle test, Dart_Handle orElse);
      E singleWhere(Dart_Handle test, Dart_Handle orElse);
  ...
  class Invocation {
    public:
      ...
      Dart_Handle getHandle() const;
      Invocation();
      static Invocation method(Symbol& memberName, Iterable< Object& >& positionalArguments, Map< Symbol&, Object& >& namedArguments);
      static Invocation genericMethod(Symbol& memberName, Iterable< Type& >& typeArguments, Iterable< Object& >& positionalArguments, Map< Symbol&, Object& >& namedArguments);
  ...
  class Map {
    public:
      ...
      static Map identity();
      static Map fromIterable(Iterable< Dart_Handle >& iterable, Dart_Handle key, Dart_Handle value);
      ...
      V update(K key, Dart_Handle update, Dart_Handle ifAbsent);
      void updateAll(Dart_Handle update);
      void removeWhere(Dart_Handle predicate);
  ...
  class Set {
    public:
      ...
      template < typename S, typename T >
      Set< T >& castFrom(Set< S >& source, Dart_Handle newSet);
      template < typename R >
      Set< R >& cast();
